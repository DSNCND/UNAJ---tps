...
namespace TPF
{
	public class Particionador
	{
		...
		public static Dictionary<string, int> class_counts(IList<IList<string>> rows){
            ...
            //cuenta el numero de cada tipo etiqueta de las filas de ejemplos en un conjunto de datos.
			...
			foreach (var row in rows) {
                ...
                //si la etiqueta no existe crea el campo con la etiqueta (y su contador en 0)
