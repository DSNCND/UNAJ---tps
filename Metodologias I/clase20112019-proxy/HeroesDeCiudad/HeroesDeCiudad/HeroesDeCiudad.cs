...
namespace HeroesDeCiudad
{
	class HeroesDeCiudad
	{
		public static void Main(string[] args)
		{
            ...
            plaza.Superficie=10;
            Calle mitre = new Calle();
            mitre.CaudalAguaXMinuto = 6;
            
            int[][] m = plaza.getSectores();
            Bombero dinamita = new Bombero();
            Medico patch = new Medico();
            Policia pp = new Policia();
            Electricista ele = new Electricista();
            Mecanico mec = new Mecanico();

            //HACK test bombero
            
            dinamita.apagarIncendio(plaza, mitre);
            Escalera e = new Escalera();

            dinamita.apagarIncendio(plaza, mitre, e);
            dinamita.apagarIncendio(plaza, mitre, new Espiral());

            dinamita.bajarGatitoDeArbol();

            patch.atenderDesmayo();
            patch.atenderInfarto();

            pp.detenerDelincuente();
            pp.patrullarCalles();
           ...
           directorDeSector director = new directorDeSector(new ConstructorSimple());
            ...
            Calle mitre = new Calle(100, 4, 5);
            Plaza plaza = new Plaza(100, mitre, 3, 3, director);
            
            Casa casa00 = new Casa(00, 100, 10, mitre, director);
            //Casa casa01 = new Casa(01, 100, 5, mitre);
            //Casa casa02 = new Casa(02, 100, 3, mitre);
            //Casa casa03 = new Casa(03, 100, 5, mitre);
            //Casa casa04 = new Casa(04, 100, 1, mitre);

            casa00.agregarObservador(bombero);
            //casa00.chispa(11,33,90);
            pausa();
            //secuencial
            bombero = new Bombero(new Escalera());
            //casa00.agregarObservador(bombero);
            //casa00.chispa(0,30,80);
            //el bombero deberia usar la estrategia spiral segun el tp de observer // pd : a implementar
            plaza.agregarObservador(bombero);

            Console.WriteLine("//////////////////////////apagar plaza");
            //ver si creo un objeto clima
            //plaza.chispa(11,33,90);
            Console.WriteLine("//////////////////////////apagar plaza");
